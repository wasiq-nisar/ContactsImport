...
#ifndef IMPORTCONTACTS_SWIFT_H
#define IMPORTCONTACTS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ImportContacts",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14ImportContacts11AppDelegate")
...
SWIFT_CLASS("_TtC14ImportContacts13SceneDelegate")
...
SWIFT_CLASS("_TtC14ImportContacts14ViewController")
@interface ViewController : UIViewController <CNContactPickerDelegate>
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified firstName;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lastName;
